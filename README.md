...
The remote JDBC executor is in place. The next major upgrade is replacing the rule-based SQL generator with an LLM-backed generator that can dynamically generate SQL from any connected database's schema.
